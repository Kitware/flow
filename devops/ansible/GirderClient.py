...
class GirderClient(object):
    ...
    # Constructor
    #-------------------------------------------------------------------------
    def __init__(self, host="localhost", port=8080, apiRoot='/api/v1'):
        """
        ...
        in all requests (HTTP Basic Auth).
            ...
            apiRoot: A string starting with '/' where the API is mounted,
            the default value is '/api/vi'.
        """
        self.host = host
        self.port = port
    ...
    #-------------------------------------------------------------------------
    def createFolder(self, parentId, parentType, name, description, public='false') :
        path = 'folder'
    ...
    #-------------------------------------------------------------------------
    # A convenience method for creating a new collection.
    #-------------------------------------------------------------------------
