    ...
    selection.each(function(data) {
      ...
      function updatePlot(p) {
        ...
        if (size >= minSize) {
          ...
          cell.select(".x.axis").remove();
          cell.select(".y.axis").remove();
      ...
      function updateCellData(toPlot) {
        numCells = toPlot.length;
